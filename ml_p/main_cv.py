...
clf = MLPClassifier(random_state=42, hidden_layer_sizes=(50, 50), early_stopping=True)

k = 5
scores = cross_validate(clf, X_train_valid, y_train_valid, cv=k, return_estimator=True)
